...
const BITHUMB_SPEC_OPERATION_IDS = {
  ...
  "service.getApiKeys": "get_api_keys",
  ...
  "orders.getTwapOrders": "get_twap_orders",
...
const COINONE_SPEC_OPERATION_IDS = {
  ...
  "market.tickerDeprecated": "ticker_deprecated",
  "market.tickerUtcDeprecated": "ticker_utc_deprecated",
  "market.recentCompletedOrdersDeprecated": "recent_completed_orders_deprecated",
...
const KORBIT_SPEC_OPERATION_IDS = {
  "market.tickers": "get_tickers",
  "market.orderbook": "get_orderbook",
  "market.trades": "get_trades",
  "market.candles": "get_candles",
  "market.currencyPairs": "get_currency_pairs",
  "market.tickSizePolicy": "get_tick_size_policy",
  "market.currencies": "get_currencies",
  "market.time": "get_time",
  "orders.placeOrder": "place_order",
  "orders.cancelOrder": "cancel_order",
  "orders.getOrder": "get_order",
  "orders.getOpenOrders": "get_open_orders",
  "orders.getAllOrders": "get_all_orders",
  "orders.getMyTrades": "get_my_trades",
  "assets.getBalance": "get_balance",
  "cryptoDeposits.getDepositAddresses": "get_coin_deposit_addresses",
  "cryptoDeposits.createDepositAddress": "create_coin_deposit_address",
  "cryptoDeposits.getDepositAddress": "get_coin_deposit_address",
  "cryptoDeposits.getRecentDeposits": "get_coin_recent_deposits",
  "cryptoDeposits.getDeposit": "get_coin_deposit",
  "cryptoWithdrawals.getWithdrawableAddresses": "get_coin_withdrawable_addresses",
  "cryptoWithdrawals.getWithdrawableAmount": "get_coin_withdrawable_amount",
  "cryptoWithdrawals.withdraw": "create_coin_withdrawal",
  "cryptoWithdrawals.cancelWithdrawal": "cancel_coin_withdrawal",
  "cryptoWithdrawals.getRecentWithdrawals": "get_coin_recent_withdrawals",
  "cryptoWithdrawals.getWithdrawal": "get_coin_withdrawal",
  "krw.sendDepositPush": "request_krw_deposit",
  "krw.sendWithdrawalPush": "request_krw_withdrawal",
  "krw.getRecentDeposits": "get_krw_recent_deposits",
  "krw.getRecentWithdrawals": "get_krw_recent_withdrawals",
  ...
  bithumbToolsCache = resolveTools(
    ...
    attachSpecOperationIds(
      ...
      [
        ...
        tool("candles", "minute", "public", [
          bithumbPublicQuery("Minute", true),
        ...
        tool("service", "getApiKeys", "private"),
  ...
  coinoneToolsCache = resolveTools(
    ...
    attachSpecOperationIds(
      ...
      [
        ...
        tool("market", "tickerDeprecated", "public", [coinonePublicQuery("TickerDeprecated")]),
        ...
        tool("market", "recentCompletedOrdersDeprecated", "public", [
          coinonePublicQuery("RecentCompletedOrdersDeprecated"),
        ]),
...
function getKorbitTools() {
  ...
  korbitToolsCache = resolveTools(
    ...
    attachSpecOperationIds(
      "korbit",
      [
        tool("market", "tickers", "public", [korbitPublicQuery("GetTickers")]),
        tool("market", "orderbook", "public", [korbitPublicQuery("GetOrderbook", true)]),
        tool("market", "trades", "public", [korbitPublicQuery("GetTrades", true)]),
        ...
        tool("orders", "getOpenOrders", "private", [korbitPrivateQuery("GetOpenOrders", true)]),
        tool("orders", "getAllOrders", "private", [korbitPrivateQuery("GetAllOrders", true)]),
        tool("orders", "getMyTrades", "private", [korbitPrivateQuery("GetMyTrades", true)]),
        tool("assets", "getBalance", "private", [korbitPrivateQuery("GetBalance")]),
        ...
        tool("cryptoDeposits", "getRecentDeposits", "private", [
          korbitPrivateQuery("GetCoinRecentDeposits", true),
        ]),
        ...
        tool("cryptoWithdrawals", "getRecentWithdrawals", "private", [
          korbitPrivateQuery("GetCoinRecentWithdrawals", true),
        ]),
        ...
        tool("krw", "getRecentDeposits", "private", [
          korbitPrivateQuery("GetKrwRecentDeposits", true),
        ]),
        tool("krw", "getRecentWithdrawals", "private", [
          korbitPrivateQuery("GetKrwRecentWithdrawals", true),
        ]),
