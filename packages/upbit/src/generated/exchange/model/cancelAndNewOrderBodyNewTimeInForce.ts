 ...
 */
export type CancelAndNewOrderBodyNewTimeInForce = typeof CancelAndNewOrderBodyNewTimeInForce[keyof typeof CancelAndNewOrderBodyNewTimeInForce];


export const CancelAndNewOrderBodyNewTimeInForce = {
  ioc: 'ioc',
  fok: 'fok',
  post_only: 'post_only',
} as const;
