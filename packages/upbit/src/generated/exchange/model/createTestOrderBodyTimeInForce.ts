 ...
 */
export type CreateTestOrderBodyTimeInForce = typeof CreateTestOrderBodyTimeInForce[keyof typeof CreateTestOrderBodyTimeInForce];


export const CreateTestOrderBodyTimeInForce = {
  fok: 'fok',
  ioc: 'ioc',
  post_only: 'post_only',
} as const;
