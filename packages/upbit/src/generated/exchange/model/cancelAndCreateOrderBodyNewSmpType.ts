 ...
 */
export type CancelAndCreateOrderBodyNewSmpType = typeof CancelAndCreateOrderBodyNewSmpType[keyof typeof CancelAndCreateOrderBodyNewSmpType];


export const CancelAndCreateOrderBodyNewSmpType = {
  reduce: 'reduce',
