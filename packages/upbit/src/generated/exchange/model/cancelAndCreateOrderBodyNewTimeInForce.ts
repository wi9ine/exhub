 ...
 */
export type CancelAndCreateOrderBodyNewTimeInForce = typeof CancelAndCreateOrderBodyNewTimeInForce[keyof typeof CancelAndCreateOrderBodyNewTimeInForce];


export const CancelAndCreateOrderBodyNewTimeInForce = {
  ioc: 'ioc',
  fok: 'fok',
  post_only: 'post_only',
} as const;
