 ...
 */
import type { RecentTradesHistory200ItemAskBid } from './recentTradesHistory200ItemAskBid';

export type RecentTradesHistory200Item = {
  /** 페어(거래쌍)의 코드
 ...
 */
  change_price: number;
  /** 매수/매도 주문 구분 */
  ask_bid: RecentTradesHistory200ItemAskBid;
  /** 체결의 유일 식별자.
