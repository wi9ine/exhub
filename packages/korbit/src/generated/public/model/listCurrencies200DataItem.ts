 ...
 */
import type { ListCurrencies200DataItemNetworkListItem } from './listCurrencies200DataItemNetworkListItem';

export type ListCurrencies200DataItem = {
  /** 자산 심볼 */
  name: string;
  /** 자산 이름 */
  fullName: string;
  ...
  /** 지원하는 블록체인 네트워크 목록 */
  networkList: ListCurrencies200DataItemNetworkListItem[];
