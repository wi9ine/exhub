 ...
 */
import type { Getv2currencies200DataItemNetworkListItem } from './getv2currencies200DataItemNetworkListItem';

export type Getv2currencies200DataItem = {
  /** 자산 심볼 */
  name: string;
  /** 자산 이름 */
  fullName: string;
  ...
  /** 지원하는 블록체인 네트워크 목록 */
  networkList: Getv2currencies200DataItemNetworkListItem[];
