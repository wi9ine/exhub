 ...
 */
export type GetOrder200DataTimeInForce = typeof GetOrder200DataTimeInForce[keyof typeof GetOrder200DataTimeInForce];


export const GetOrder200DataTimeInForce = {
  gtc: 'gtc',
  ioc: 'ioc',
  fok: 'fok',
  po: 'po',
