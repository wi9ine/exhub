 ...
 */
import type { GetCoinWithdrawal200DataStatus } from './getCoinWithdrawal200DataStatus';

export type GetCoinWithdrawal200Data = {
  /** 가상자산 출금 ID */
  id: number;
...
- failed 출금 실패 (잔고 부족 또는 기타 오류) */
  status: GetCoinWithdrawal200DataStatus;
  /** 블록체인 네트워크 심볼 */
  network: string;
  /** 출금 주소 */
  address: string;
