 ...
 */
export type Getv2orders200DataTimeInForce = typeof Getv2orders200DataTimeInForce[keyof typeof Getv2orders200DataTimeInForce];


export const Getv2orders200DataTimeInForce = {
  gtc: 'gtc',
  ioc: 'ioc',
  fok: 'fok',
  po: 'po',
