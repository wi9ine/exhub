 ...
 */
import type { Getv2orders200DataOrderType } from './getv2orders200DataOrderType';
import type { Getv2orders200DataSide } from './getv2orders200DataSide';
import type { Getv2orders200DataStatus } from './getv2orders200DataStatus';
import type { Getv2orders200DataTimeInForce } from './getv2orders200DataTimeInForce';

export type Getv2orders200Data = {
  /** 주문 ID */
  orderId: number;
  /** 사용자 지정 주문 ID */
...
- best BBO 주문 (Best-Bid-Offer, 최우선/최유리) */
  orderType: Getv2orders200DataOrderType;
  /** 매수, 매도 구분

- buy 매수

- sell 매도 */
  side: Getv2orders200DataSide;
  /** 주문 취소 조건
...
BBO 주문에서는 Time in Force 값을 반드시 직접 입력해야 합니다. */
  timeInForce: Getv2orders200DataTimeInForce;
  /** 평균 체결 단가 */
  avgPrice: string;
...
- expired 주문 접수 실패 (잔고 부족 또는 timeInForce 조건 해당 시) */
  status: Getv2orders200DataStatus;
