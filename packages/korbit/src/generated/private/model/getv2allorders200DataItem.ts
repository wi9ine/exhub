 ...
 */
import type { Getv2allorders200DataItemOrderType } from './getv2allorders200DataItemOrderType';
import type { Getv2allorders200DataItemSide } from './getv2allorders200DataItemSide';
import type { Getv2allorders200DataItemStatus } from './getv2allorders200DataItemStatus';
import type { Getv2allorders200DataItemTimeInForce } from './getv2allorders200DataItemTimeInForce';

export type Getv2allorders200DataItem = {
  /** 주문 ID */
  orderId: number;
  /** 사용자 지정 주문 ID */
...
- best BBO 주문 (Best-Bid-Offer, 최우선/최유리) */
  orderType: Getv2allorders200DataItemOrderType;
  /** 매수, 매도 구분

- buy 매수

- sell 매도 */
  side: Getv2allorders200DataItemSide;
  /** 주문 취소 조건
...
BBO 주문에서는 Time in Force 값을 반드시 직접 입력해야 합니다. */
  timeInForce?: Getv2allorders200DataItemTimeInForce;
...
- expired 주문 접수 실패 (잔고 부족 또는 timeInForce 조건 해당 시) */
  status: Getv2allorders200DataItemStatus;
};
