 ...
 */
import type { GetOrder200DataOrderType } from './getOrder200DataOrderType';
import type { GetOrder200DataSide } from './getOrder200DataSide';
import type { GetOrder200DataStatus } from './getOrder200DataStatus';
import type { GetOrder200DataTimeInForce } from './getOrder200DataTimeInForce';
...
- best BBO 주문 (Best-Bid-Offer, 최우선/최유리) */
  orderType: GetOrder200DataOrderType;
  /** 매수, 매도 구분

- buy 매수

- sell 매도 */
  side: GetOrder200DataSide;
  /** 주문 취소 조건
...
BBO 주문에서는 Time in Force 값을 반드시 직접 입력해야 합니다. */
  timeInForce: GetOrder200DataTimeInForce;
  /** 평균 체결 단가 */
  avgPrice: string;
