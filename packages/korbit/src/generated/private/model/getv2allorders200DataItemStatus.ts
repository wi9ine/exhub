 ...
 */
export type Getv2allorders200DataItemStatus = typeof Getv2allorders200DataItemStatus[keyof typeof Getv2allorders200DataItemStatus];


export const Getv2allorders200DataItemStatus = {
  pending: 'pending',
  open: 'open',
  filled: 'filled',
  canceled: 'canceled',
