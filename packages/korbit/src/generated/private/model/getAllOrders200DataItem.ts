 ...
 */
import type { GetAllOrders200DataItemOrderType } from './getAllOrders200DataItemOrderType';
import type { GetAllOrders200DataItemSide } from './getAllOrders200DataItemSide';
import type { GetAllOrders200DataItemStatus } from './getAllOrders200DataItemStatus';
import type { GetAllOrders200DataItemTimeInForce } from './getAllOrders200DataItemTimeInForce';

export type GetAllOrders200DataItem = {
  /** 주문 ID */
  orderId: number;
  /** 사용자 지정 주문 ID */
...
- best BBO 주문 (Best-Bid-Offer, 최우선/최유리) */
  orderType: GetAllOrders200DataItemOrderType;
  /** 매수, 매도 구분

- buy 매수

- sell 매도 */
  side: GetAllOrders200DataItemSide;
  /** 주문 취소 조건
...
BBO 주문에서는 Time in Force 값을 반드시 직접 입력해야 합니다. */
  timeInForce?: GetAllOrders200DataItemTimeInForce;
...
- expired 주문 접수 실패 (잔고 부족 또는 timeInForce 조건 해당 시) */
  status: GetAllOrders200DataItemStatus;
};
