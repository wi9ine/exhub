 ...
 */
import type { GetCoinRecentDeposits200DataItemStatus } from './getCoinRecentDeposits200DataItemStatus';

export type GetCoinRecentDeposits200DataItem = {
  /** 코인 입금 ID */
  id: number;
  /** 블록체인 네트워크 심볼 */
  network: string;
...
- failed 입금 실패 (입금 트랜잭션에 문제가 있는 경우 등) */
  status: GetCoinRecentDeposits200DataItemStatus;
  /** 블록체인 트랜잭션 해시 */
