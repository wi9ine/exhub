...
| -best\_asks       | Array\[Object] | 매도 최저가 오더북 정보                     |
...
```json
{
  ...
  "paths": {
    "/public/v2/ticker_utc_new/{quote_currency}": {
      "get": {
        "summary": "전체 티커 정보 조회 (UTC)",
        "description": "UTC 기준으로 마켓의 모든 티커 정보 조회",
        "operationId": "utc-tickers",
        "parameters": [
          {
            "name": "quote_currency",
            "in": "path",
  ...
  "_id": "68394678760f3c0030350496:68394678760f3c00303504b0"
}
```