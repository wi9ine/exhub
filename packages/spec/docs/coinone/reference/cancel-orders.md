...
| canceled\_count     | Number       | 취소된 주문의 개수                        |
| total\_order\_count | Number       | 전체 주문의 개수                         |
...
```json
{
  ...
  "paths": {
    "/v2.1/order/cancel/all": {
      "post": {
        ...
        "description": "특정 종목에 걸려있는 전체 주문의 취소",
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "quote_currency": {
                    "type": "string",
                    "description": "\b마켓 기준 통화",
                    "default": "KRW"
                  },
                  "target_currency": {
                    "type": "string",
                    "description": "취소하려는 종목의 심볼",
                    "default": "BTC"
                  }
                }
              }
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504a7"
}
```