...
| currency      | string  | optional          | 조회하려는 종목의 심볼, 입력하지 않으면 모든 종목 조회                                     |
...
| transaction                | Array\[Object] | 배열 형태의 가상자산 입출금 목록                                                       |
...
```json
{
  ...
  "paths": {
    "/v2.1/transaction/coin/history": {
      "post": {
        ...
        "description": "가상자산의 전체 입출금 내역 조회",
        "operationId": "coin-transaction-history",
        "parameters": [
          {
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "currency": {
                    "type": "string",
                    "description": "조회하려는 종목의 심볼, 입력하지 않으면 모든 종목 조회",
                    "default": "BTC"
                  },
                  "to_id": {
                    "type": "string",
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504b5"
}
```