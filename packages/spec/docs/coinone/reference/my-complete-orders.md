...
| completeOrders | Array\[Object] | 배열 형태의 체결 주문 정보 목록                      |
| - timestamp    | NumberString   | 체결 시점의 타임스탬프                            |
| - price        | NumberString   | 체결 주문 가격                                |
| - type         | String         | 체결 주문 타입 (Enum: ask인 경우 매도, bid인 경우 매수) |
| - qty          | NumberString   | 체결 주문 수량                                |
...
```json
{
  ...
  "paths": {
    "/v2/order/complete_orders": {
      "post": {
        "summary": "\b체결 주문 조회",
        "description": "체결된 주문 정보 조회",
        "operationId": "my-complete-orders",
        "parameters": [
          {
                    ...
                    "completeOrders": {
                      ...
                      "items": {
                        ...
                        "properties": {
                          ...
                          "orderId": {
                            "type": "string",
                            "example": "E84A1AC2-8088-4FA0-B093-A3BCDB9B3C85"
                          }
                        }
                      }
                    }
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504c0"
}
```