...
| normalWallets | Array\[Object] | 배열 형태의 BTC 지갑 정보                  |
| - balance     | NumberString   | BTC 잔고 수량                         |
| - label       | String         | BTC 지갑 라벨명                        |
| {symbol}      | Object         | 배열 형태의 가상자산 별 지갑 정보               |
| - avail       | NumberString   | 가용한 가상자산 수량                       |
| - balance     | NumberString   | 보유한 전체 가상자산 수량                    |
...
```json
{
  ...
  "paths": {
    "/v2/account/balance": {
      "post": {
        "summary": "잔고 조회",
        "description": "고객이 보유한 가상자산 잔고 조회",
        "operationId": "balance",
        "parameters": [
          {
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504a0"
}
```