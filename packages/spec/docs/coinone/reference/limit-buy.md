...
```json
{
  ...
  "paths": {
    "/v2/order/limit_buy": {
      "post": {
        "summary": "지정가 매수 주문",
        "description": "Limit 방식으로 매수 주문 등록",
        "operationId": "limit-buy",
        "parameters": [
          {
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "price": {
                    "type": "string",
                    "description": "원하는 매수 가격 입력 (KRW)"
                  },
                  "qty": {
                    "type": "string",
                    "description": "매수를 원하는 만큼의 가상자산의 수량"
                  },
                  "currency": {
                    "type": "string",
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504bd"
}
```