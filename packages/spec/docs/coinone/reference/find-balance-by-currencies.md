...
| - average\_price | NumberString   | 구매한 종목의 평단가 (종목 단위로 표시)                |
...
```json
{
  ...
  "paths": {
    "/v2.1/account/balance": {
      "post": {
        "summary": "특정 자산 잔고 조회",
        "description": "고객이 보유한 특정 종목의 잔고 조회",
        "operationId": "find-balance-by-currencies",
        "parameters": [
          {
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "currencies": {
                    "type": "array",
                    "description": "잔고 조회하려는 자산의 심볼 입력",
                    "default": [
                      "\"BTC\"",
                      "\"KRW\"",
                      "\"ETH\""
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504a1"
}
```