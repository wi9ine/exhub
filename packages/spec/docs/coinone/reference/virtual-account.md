...
| depositor     | String       | 가상계좌 소유자 명                        |
| bankName      | String       | 가상계좌 제공 은행                        |
...
```json
{
  ...
  "paths": {
    "/v2/account/virtual_account": {
      "post": {
        "summary": "가상계좌 정보 조회",
        "description": "가상계좌와 관련된 정보들을 조회",
        "operationId": "virtual-account",
        "parameters": [
          {
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504bb"
}
```