...
```json
{
  ...
  "paths": {
    "/v2.1/transaction/coin/withdrawal/limit": {
      "post": {
        ...
        "description": "가상자산의 전일 종가를 기준으로 출금 가능 한도를 조회",
        "operationId": "coin-withdrawal-limit",
        "parameters": [
          {
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "currency": {
                    "type": "string",
                    "description": "출금한도를 조회하려는 종목의 심볼",
                    "default": "BTC"
                  }
                }
              }
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504b6"
}
```