...
| limitOrders | Array\[Object] | 배열 형태의 지정가 주문 목록                      |
| - index     | String         | 주문 인덱스                                |
| - orderId   | String         | 주문 식별 id                              |
| - timestamp | NumberString   | 주문 등록 시점의 타임스탬프                       |
| - price     | NumberString   | 주문 가격 (KRW)                           |
| - qty       | NumberString   | 주문 수량                                 |
| - type      | String         | 주문 타입 (Enum: ask인 경우 매도 , bid인 경우 매수) |
...
```json
{
  ...
  "paths": {
    "/v2/order/limit_orders": {
      "post": {
        "summary": "지정가 주문 조회",
        "description": "고객이 등록한 지정가 주문에 대한 정보 조회",
        "operationId": "my-limit-orders",
        "parameters": [
          {
                    ...
                    "limitOrders": {
                      ...
                      "items": {
                        ...
                        "properties": {
                          ...
                          "orderId": {
                            "type": "string",
                            "example": "68665943-1eb5-4e4b-9d76-845fc54f5489"
                          },
                          "timestamp": {
                            "type": "string",
                            "example": "1449037367"
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504bf"
}
```