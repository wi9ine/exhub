...
| walletAddress | Object       | 지갑 주소 오브젝트                        |
| - xrp\_tag    | String       | XRP의 태그 정보 반환                     |
| - eos\_memo   | String       | EOS의 메모 정보 반환                     |
| - {symbol}    | String       | 가상자산 별로 주소 정보 반환                  |
...
```json
{
  ...
  "paths": {
    "/v2/account/deposit_address": {
      "post": {
        "summary": "입금 주소 조회",
        "description": "가상자산 별 입금 주소 조회",
        "operationId": "deposit-address",
        "parameters": [
          {
                  ...
                  "properties": {
                    ...
                    "walletAddress": {
                      ...
                      "properties": {
                        "btc": {
                          "type": "string",
                          "example": "mnobqu4i6qMCJWDpf5UimRmr8JCvZ8FLcN"
                        },
                        "eth": {
                          "type": "string",
                          "example": "0x61bB630D3B2e8eda0FC1d50F9f958eC02e3969F6"
                        },
                        "xrp": {
                          "type": "string",
                          "example": "rGf3sLFW6q65YeQDCGDEFeFTKLKNxy6rDg"
                        },
                        "xrp_tag": {
                          "type": "string",
                          "example": "1289063454"
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504b8"
}
```