...
| -quote\_volume    | NumberString   | 최근 24시간 기준 종목 체결 금액 (원화)          |
| -target\_volume   | NumberString   | 최근 24시간 기준 종목 체결량 (종목)            |
| -best\_asks       | Array\[Object] | 매도 최저가 오더 정보                      |
| --price           | NumberString   | 매도 가격북                            |
| --qty             | NumberString   | 매도 수량                             |
| -best\_bids       | Array\[Object] | 매수 최고가 오더북 정보                     |
...
```json
{
  ...
  "paths": {
    "/public/v2/ticker_utc_new/{quote_currency}/{target_currency}": {
      "get": {
        "summary": "개별 티커 정보 조회 (UTC)",
        "description": "UTC 기준으로 특정 종목의 티커 정보 조회",
        "operationId": "utc-ticker",
        "parameters": [
          {
            "name": "quote_currency",
            "in": "path",
            "description": "마켓의 기준 통화",
            "schema": {
              "type": "string",
              "default": "KRW"
            },
  ...
  "_id": "68394678760f3c0030350496:68394678760f3c00303504c6"
}
```