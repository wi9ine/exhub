...
| quote\_currency  | string | true  | 마켓 기준 통화                                               |
| target\_currency | string | true  | 조회하려는 종목의 심볼                                           |
...
```json
{
  ...
  "paths": {
    "/v2.1/order/completed_orders": {
      "post": {
        ...
        "description": "특정 종목의 체결된 주문 조회",
        "operationId": "find-completed-orders",
        "parameters": [
          {
  ...
  "_id": "68394678760f3c0030350497:68394678760f3c00303504aa"
}
```