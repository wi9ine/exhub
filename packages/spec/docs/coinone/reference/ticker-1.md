...
> 🚧 해당 API는 Deprecated되어 Public API V2 '전체 티커 정보 조회' API를 사용하시기 바랍니다
>
> [V2 전체 티커 정보 조회](https://coinone.readme.io/v1.0/reference/tickers)
...
```json
{
  ...
  "_id": "68394678760f3c0030350496:68394678760f3c00303504b7"
}
```